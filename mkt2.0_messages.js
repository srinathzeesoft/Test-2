Mkt3L10n.AccountAnalyzerChart = {
  Trend: "Trend test test test test test",
  Opportunity: "Opportunity test test test test check check check check test test test test test test test test test test test",
